exports.handler = async (event) => {
  ...
  if (req.headers.cookie) {
    ...
    previousWeight = +(req.headers.cookie.find(c => c.value.startsWith('${ReleaseName}=')) || '0').value.match('=(\\d+)')[1]
  }
  ...
  //   req.headers.host = [{key: 'host', value: req.origin.s3.domainName = '${NextBucket}'}]
  // }
  // return req
}
